...
export default function TeacherGroups() {
  const { data: groups, isLoading } = useQuery('teacher-groups', () =>
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Guruhlarim</h1>
          <p className="text-gray-600 mt-1">Mening o'quv guruhlarim</p>
        </div>
